...
<?php
  $business_corporate_agency_content = apply_filters( 'the_content', get_the_content() );
  $video = false;

  // Only get video from the content if a playlist isn't present.
  if ( false === strpos( $business_corporate_agency_content, 'wp-playlist-script' ) ) {
    $video = get_media_embedded_in_content( $business_corporate_agency_content, array( 'video', 'object', 'embed', 'iframe' ) );
  }
?>
<?php $business_corporate_agency_column_layout = get_theme_mod( 'business_corporate_agency_sidebar_post_layout');
if($business_corporate_agency_column_layout == 'four-column' || $business_corporate_agency_column_layout == 'three-column' ){ ?>
