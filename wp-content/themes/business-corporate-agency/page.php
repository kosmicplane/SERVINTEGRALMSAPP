	...
	<main id="tp_content" role="main">
		<div class="container">
			<div id="primary" class="content-area">
				<?php $business_corporate_agency_sidebar_layout = get_theme_mod( 'business_corporate_agency_sidebar_page_layout','right');
			        ...
			        <div class="row">
			          	...
			          	<div class="col-lg-8 col-md-8 singlepage-main">
			           		<?php while ( have_posts() ) : the_post();
									...
									wp_link_pages( array(
										'before' => '<div class="page-links">' . __( 'Pages:', 'business-corporate-agency' ),
										'after'  => '</div>',
									) );
