            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#Cosmobit_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('Cosmobit_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="cosmobit_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="cosmobit_feature_thumbnail-button">Change Image</button> ' +
