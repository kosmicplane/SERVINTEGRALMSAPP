(function ($) {
    ...
    wp.cosmobitcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                cosmobit_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.cosmobitcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.cosmobitcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.cosmobitcustomizerRepeater.iconPickerToggle($(this));
        });
