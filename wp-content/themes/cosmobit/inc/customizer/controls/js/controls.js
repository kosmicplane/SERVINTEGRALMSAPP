...
( function( api ) {
	...
	// Extends our custom "cosmobit" section.
	api.sectionConstructor['cosmobit'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-cosmobit_sidebar_options select:not(#_customize-input-cosmobit_default_pg_sidebar_option), #sub-accordion-section-cosmobit_typography_options select, #sub-accordion-section-cosmobit_headings_typography select").prop('disabled', true);
});