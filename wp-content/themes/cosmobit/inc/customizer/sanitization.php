 ...
 */
function cosmobit_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function cosmobit_sanitize_html( $html ) {
 ...
 */
function cosmobit_sanitize_select( $input, $setting ) {
 ...
 */
function cosmobit_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function cosmobit_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function cosmobit_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}