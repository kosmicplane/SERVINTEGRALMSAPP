...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'g5plus-darna' ), strip_tags( $args['product_name'] ) ) : '';
	?>
    <div class="quantity">
        <div class="quantity-inner">
            ...
            <input type="text" step="<?php echo esc_attr($step); ?>"
                   ...
                   title="<?php _ex('Qty', 'Product quantity input tooltip', 'g5plus-darna') ?>" class="input-text qty text"
                   size="4"/>
