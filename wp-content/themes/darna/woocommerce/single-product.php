...
if (!in_array($sidebar, array('none','left','right','both'))) {
    ...
    if (($sidebar === '') || ($sidebar == '-1')) {
        $sidebar = g5plus_get_option('single_product_sidebar','none');
    }
}
...
if (($left_sidebar === '') || ($left_sidebar == '-1')) {
    $left_sidebar = g5plus_get_option('single_product_left_sidebar','sidebar-1');
}

$right_sidebar = g5plus_get_post_meta(get_the_ID(), 'g5plus_page_right_sidebar', true);
if (($right_sidebar === '') || ($right_sidebar == '-1')) {
    $right_sidebar = g5plus_get_option('single_product_right_sidebar','sidebar-2');
}
