...
if (($opt_header_shopping_cart_button['view-cart'] == '1')
...
<div class="<?php echo join(' ', $cart_list_sub_class)?>">
	<ul class="cart_list product_list_widget <?php echo esc_attr($args['list_class']); ?>">
		...
		<?php else : ?>
			<li class="empty">
				<h4><?php esc_html_e( 'An empty cart', 'g5plus-darna' ); ?></h4>
				<p><?php esc_html_e( 'You have no item in your shopping cart', 'g5plus-darna' ); ?></p>
			</li>
		<?php endif; ?>
	...
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		<div class="cart-total">
			<p class="total"><strong><?php esc_html_e( 'Subtotal', 'g5plus-darna' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
			...
			<p class="buttons <?php echo esc_attr($both_button) ?>">
				<?php if (isset($opt_header_shopping_cart_button['view-cart']) && ($opt_header_shopping_cart_button['view-cart'] == '1')):?>
					<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="button wc-forward"><i class="fa fa-shopping-cart"></i> <?php esc_html_e( 'View Cart', 'g5plus-darna' ); ?></a>
				<?php endif; ?>
				<?php if (isset($opt_header_shopping_cart_button['checkout']) && ($opt_header_shopping_cart_button['checkout'] == '1')):?>
					<a href="<?php echo esc_url(wc_get_checkout_url()); ?>" class="button checkout wc-forward"><i class="fa fa-check"></i> <?php esc_html_e( 'Checkout', 'g5plus-darna' ); ?></a>
				<?php endif; ?>
			</p>
		</div>
	<?php endif; ?>
