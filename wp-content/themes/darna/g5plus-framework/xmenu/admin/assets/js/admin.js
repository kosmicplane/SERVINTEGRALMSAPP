	...
	var XMENU = {
		...
		add_xmenu_to_wpmenu: function() {
			$('ul.menu > li.menu-item').each(function(){
				...
				$('> .menu-item-bar > .menu-item-handle > .item-title > .menu-item-title', this).append('<span class="xmenu-item-config" data-id="' + menu_id + '"><i class="fa fa-cogs"></i> XMENU <i class="fa fa-warning"></i></span>');
			});
		...
		reset: function() {
			$('.xmenu-config-panel-wrapper li.x-reset').click(function(){
				...
				$('.xmenu-header .xmenu-config-panel-save i').attr('class','fa fa-warning');
				$('.menu-item-title .xmenu-item-config[data-id="' + menu_id + '"]').addClass('is-change');
			});
		},
			...
			$('.xmenu-header .xmenu-config-panel-save').click(function() {
				...
				$.ajax({
					...
					success: function(data) {
						...
						$('.menu-item-title .xmenu-item-config[data-id="' + menu_id + '"]').removeClass('is-change');
