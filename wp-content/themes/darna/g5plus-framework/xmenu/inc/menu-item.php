	...
	<div class="xmenu-config-panel-wrapper">
		<div class="xmenu-header">
			<h2>
				...
				<button class="x-button xmenu-config-panel-save" type="button"><i class="fa fa-save"></i> <?php echo esc_html__('Save Changes','g5plus-darna') ?></button>
		...
		<div class="xmenu-config-panel-left">
			<ul>
				...
				<li class="<?php echo esc_attr($item_key == 'general' ? 'active' :'') ?>"  rel-section="<?php echo esc_attr('section-' . $item_key) ?>"><i class="fa <?php echo esc_attr($item_value['icon']) ?>"></i><span><?php echo esc_html($item_value['text']) ?></span></li>
				<?php endforeach; ?>
				<li class="x-reset">
					<i class="fa fa-refresh"></i> <?php _e('Reset','g5plus-darna') ?>
				</li>
			</ul>
		</div>
		<form class="xmenu-config-panel-right">
			<div class="xmenu-config-panel-right-inner">
				<?php foreach ($xmenu_item_settings as $item_key => $item_value): ?>
					<section class="<?php echo esc_attr($item_key == 'general' ? 'active' :'') ?>" id="<?php echo esc_attr('section-' . $item_key) ?>">
		...
		<div class="xmenu-icon-popup">
			<div class="xmenu-icon-popup-header">
				<input type="text" placeholder="<?php _e('Type to search...','g5plus-darna') ?>"/>
...
function xmenu_save_config_callback() {
	$error_result = array(
		'code' => '-1',
		'message' => esc_html__('Save menu config fail','g5plus-darna'),
	);
