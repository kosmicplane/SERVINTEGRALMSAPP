<?php
$home_preloader = g5plus_get_option('home_preloader','none');

if ($home_preloader == 'none' || empty($home_preloader)) {
    return;
}
$home_preloader_bg_color = g5plus_get_option('home_preloader_bg_color',array());
$home_preloader_spinner_color = g5plus_get_option('home_preloader_spinner_color');

$custom_bg_color = '';
if (isset($home_preloader_bg_color['rgba'])) {
