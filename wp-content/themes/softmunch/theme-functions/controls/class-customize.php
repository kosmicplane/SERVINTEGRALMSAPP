 ...
 */
final class SoftMunch_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to SoftMunch Pro','softmunch' ),
                    'pro_url'  => 'https://desertthemes.com/themes/softmunch-pro/',
                    'priority' => 0
                )
			)
		);
...
SoftMunch_Customize::get_instance();