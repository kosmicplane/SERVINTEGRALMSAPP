	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Cosmobit_Customize_Section_Pro(
				...
				'cosmobit',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Crombit Pro','crombit' ),
                    'pro_url'  => 'https://desertthemes.com/themes/crombit-pro/',
                    'priority' => 0
                )
			)
		);
...
Crombit_Customize::get_instance();