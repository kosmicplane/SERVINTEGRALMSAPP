...
<?php } ?>
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h6><?php if(isset($norcon_redux_demo['blog_subtitle'])){?>
                            <?php echo esc_attr($norcon_redux_demo['blog_subtitle']);?>
                            <?php }else{?>
                            <?php echo esc_html__( 'Our Blog', 'norcon' ); } ?></h6>
                <h1><?php if(isset($norcon_redux_demo['blog_title'])){?>
                            <?php echo esc_attr($norcon_redux_demo['blog_title']);?>
                            <?php }else{?>
                            <?php echo esc_html__( 'Latest News', 'norcon' ); } ?></h1>
            </div>
        </div>
    </div>
</section>
