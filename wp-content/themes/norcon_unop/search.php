...
<?php } ?>
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1><?php printf( esc_html__( 'Search Results for: %s', 'conster' ), get_search_query() ); ?></h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="col-md-8">
            <?php if ( have_posts() ) : 
                ...
                <div class="search-custom" >
                    <h4>
                        <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'norcon' ) ;?>
                    </h4>
                    <?php get_search_form();  ?>
                </div> 
                <?php endif;?>
