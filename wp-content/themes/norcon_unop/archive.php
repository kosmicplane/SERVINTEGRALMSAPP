    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1><?php
                    if ( is_day() ) :
                        printf( esc_html__( 'Daily Archives: %s', 'norcon' ), get_the_date() );
                    elseif ( is_month() ) :
                        printf( esc_html__( 'Monthly Archives: %s', 'norcon' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'norcon' ) ) );
                    elseif ( is_year() ) :
                        printf( esc_html__( 'Yearly Archives: %s', 'norcon' ), get_the_date( _x( 'Y', 'yearly archives date format', 'norcon' ) ) );
                    else :
                        echo esc_html__( 'Archives', 'norcon' );
                    endif;?></h1>
            </div>
        </div>
    </div>
