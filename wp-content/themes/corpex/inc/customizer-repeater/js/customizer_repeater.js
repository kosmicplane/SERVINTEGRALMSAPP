/* global jQuery */
/* global wp */
function corpex_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function corpex_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function corpex_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + corpex_customizer_repeater_uniqid();
    ...
    corpex_customizer_repeater_refresh_general_control_values();
}


function corpex_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var item_choice = jQuery(this).find('.customizer-repeater-image2-choice').val();
            ...
            if (!id) {
                id = 'social-repeater-' + corpex_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== ''  || image_url2 !== '' || item_choice !== '' || video_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    'icon_value': (choice === 'customizer_repeater_none' ? '' : icon_value),
                    'color': color,
                    'color2': color2,
                    'text': corpexescapeHtml(text),
                    'link': link,
                    'text2': corpexescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
					'item_choice': item_choice,
					'image_url2': (item_choice === 'customizer_repeater_none' ? '' : image_url2),
					'video_url': (item_choice === 'customizer_repeater_none' ? '' : video_url),
                    'title': corpexescapeHtml(title),
                    'subtitle': corpexescapeHtml(subtitle),
					'subtitle2': corpexescapeHtml(subtitle2),
					'subtitle3': corpexescapeHtml(subtitle3),
					'subtitle4': corpexescapeHtml(subtitle4),
					'subtitle5': corpexescapeHtml(subtitle5),
					'slide_align': corpexescapeHtml(slide_align),
                    'social_repeater': corpexescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': corpexescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var corpex_theme_controls = jQuery('#customize-theme-controls');
    corpex_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    corpex_theme_controls.on('change', '.icp',function(){
        corpex_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	corpex_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		corpex_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
	corpex_theme_controls.on('change','.customizer-repeater-image2-control', function(){
		corpex_customizer_repeater_refresh_general_control_values();
        return false;
    ...
    corpex_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
	...
	jQuery('.customizer-repeater-image2-choice').parent().parent().find('.customizer-repeater-image2-control').hide();
	 corpex_theme_controls.on('change', '.customizer-repeater-image2-choice', function () {
        if (jQuery(this).val() === 'customizer_repeater_image2') {
            jQuery(this).parent().parent().find('.customizer-repeater-video-url-control').hide();
            jQuery(this).parent().parent().find('.customize-control-title.Video.Url').hide();
            jQuery(this).parent().parent().find('.customizer-repeater-image2-control').show();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').prev().prev().hide();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').hide();

        }
        if (jQuery(this).val() === 'customizer_repeater_video') {
            jQuery(this).parent().parent().find('.customizer-repeater-video-url-control').show();
            jQuery(this).parent().parent().find('.customize-control-title.Video.Url').show();
            jQuery(this).parent().parent().find('.customizer-repeater-image2-control').hide();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').prev().prev().show();
            jQuery(this).parent().parent().find('.customizer-repeater-color-control').show();
        }
        if (jQuery(this).val() === 'customizer_repeater_none') {
    ...
    corpex_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    corpex_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + corpex_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Slid")
        {
        if(jQuery('#exist_corpex_Slide').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Slide').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Slide').val())+1;
         jQuery('#exist_corpex_Slide').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_corpex_Service').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Service').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Service').val())+1;
         jQuery('#exist_corpex_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Info")
        {
        if(jQuery('#exist_corpex_Info').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Info').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Info').val())+1;
         jQuery('#exist_corpex_Info').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_corpex_Social').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Social').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Social').val())+1;
         jQuery('#exist_corpex_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Test")
        {
        if(jQuery('#exist_corpex_Testimonial').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Testimonial').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Testimonial').val())+1;
         jQuery('#exist_corpex_Testimonial').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Menu")
        {
        if(jQuery('#exist_corpex_Menus').val()>=2)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Menus').val()<2)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Menus').val())+1;
         jQuery('#exist_corpex_Menus').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Clie")
        {
        if(jQuery('#exist_corpex_Client').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Client').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Client').val())+1;
         jQuery('#exist_corpex_Client').val(new_service_add_val);  
        }
        }		
		
		if(split_add_more_button_split=="Add New Feat")
        {
        if(jQuery('#exist_corpex_Features').val()>=8)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Features').val()<8)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Features').val())+1;
         jQuery('#exist_corpex_Features').val(new_service_add_val);  
        }
        }

		if(split_add_more_button_split=="Add New Team")
        {
        if(jQuery('#exist_corpex_Team').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Team').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Team').val())+1;
         jQuery('#exist_corpex_Team').val(new_service_add_val);  
        }
        }

		if(split_add_more_button_split=="Add New Funf")
        {
        if(jQuery('#exist_corpex_Funfact').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Funfact').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Funfact').val())+1;
         jQuery('#exist_corpex_Funfact').val(new_service_add_val);  
        }
        }

		if(split_add_more_button_split=="Add New Proc")
        {
        if(jQuery('#exist_corpex_Process').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Process').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Process').val())+1;
         jQuery('#exist_corpex_Process').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Port")
        {
        if(jQuery('#exist_corpex_Portfolio').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_corpex_Portfolio').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_corpex_Portfolio').val())+1;
         jQuery('#exist_corpex_Portfolio').val(new_service_add_val);  
        }
        }
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
				...
				field.find('.customizer-repeater-image2-choice').val('customizer_repeater_video');
				...
				/*Remove value from media field*/
               // field.find('.customizer-repeater-overlay-choice').val('');
    ...
    corpex_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_corpex_Slide').val(parseInt(jQuery('#exist_corpex_Slide').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_corpex_Service').val(parseInt(jQuery('#exist_corpex_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Info	")/* 4 Char */
                {
                jQuery('#exist_corpex_Info').val(parseInt(jQuery('#exist_corpex_Info').val())-1); 
                }
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_corpex_Social').val(parseInt(jQuery('#exist_corpex_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Testi")
                {
                jQuery('#exist_corpex_Testimonial').val(parseInt(jQuery('#exist_corpex_Testimonial').val())-1); 
                }
				if(split_delete_button_split=="Delete Menus")
                {
                jQuery('#exist_corpex_Menus').val(parseInt(jQuery('#exist_corpex_Menus').val())-1); 
                }
				if(split_delete_button_split=="Delete Clien")
                {
                jQuery('#exist_corpex_Client').val(parseInt(jQuery('#exist_corpex_Client').val())-1); 
                }				
				if(split_delete_button_split=="Delete Featu")
                {
                jQuery('#exist_corpex_Features').val(parseInt(jQuery('#exist_corpex_Features').val())-1); 
                }
				if(split_delete_button_split=="Delete Team")
                {
                jQuery('#exist_corpex_Team').val(parseInt(jQuery('#exist_corpex_Team').val())-1); 
                }
				if(split_delete_button_split=="Delete Funfa")
                {
                jQuery('#exist_corpex_Funfact').val(parseInt(jQuery('#exist_corpex_Funfact').val())-1); 
                }
				if(split_delete_button_split=="Delete Proce")
                {
                jQuery('#exist_corpex_Process').val(parseInt(jQuery('#exist_corpex_Process').val())-1); 
                }
				if(split_delete_button_split=="Delete Portf")
                {
                jQuery('#exist_corpex_Portfolio').val(parseInt(jQuery('#exist_corpex_Portfolio').val())-1); 
                }
    ...
    corpex_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
    ...
    corpex_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
	
	 corpex_theme_controls.on('keyup', '.customizer-repeater-subtitle2-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
	
	corpex_theme_controls.on('keyup', '.customizer-repeater-subtitle3-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
	
	corpex_theme_controls.on('keyup', '.customizer-repeater-subtitle4-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
	
	corpex_theme_controls.on('keyup', '.customizer-repeater-subtitle5-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });

    corpex_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });

    corpex_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });

    corpex_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });

    corpex_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
	
	corpex_theme_controls.on('keyup','.customizer-repeater-video-url-control', function(){		
		corpex_customizer_repeater_refresh_general_control_values();
	});

    corpex_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        corpex_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    corpex_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + corpex_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    corpex_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        corpex_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    corpex_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        corpex_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    corpex_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function corpexescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return corpexentityMap[s];
    });
