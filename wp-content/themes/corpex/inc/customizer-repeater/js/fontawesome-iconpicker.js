(function ($) {
    ...
    wp.corpexcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                corpex_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.corpexcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.corpexcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.corpexcustomizerRepeater.iconPickerToggle($(this));
        });
