...
/**
 * Corpex
 * Customizer Control: Corpex Radio Image control
 */
 if ( ! class_exists( 'Corpex_Customize_Base_Control' ) ) {
	return;
}

class Corpex_Customize_Control_Radio_Image extends Corpex_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'corpex-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="corpex-radio-image-select">
