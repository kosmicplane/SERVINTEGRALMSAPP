 ...
 * @access public
 */
class Corpex_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Corpex_Customizer_Range_Control constructor.
	 *
 ...
 */
function corpex_pro_sanitize_range_value( $input ) {
	if ( corpex_pro_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function corpex_pro_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
