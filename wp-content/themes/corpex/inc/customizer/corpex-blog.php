<?php
function corpex_blog_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_section(
		'blog_setting', array(
			'title' => esc_html__( 'Blog Section', 'corpex' ),
			'priority' => 10,
	...
	$wp_customize->add_setting(
    	'blog_title',
    	array(
			'default'			=> __('Our <span>Blog</span>','corpex'),
			'capability'     	=> 'edit_theme_options',
	...
	$wp_customize->add_setting(
    	'blog_description',
    	array(
			'default'			=> __('There are many variations of passages of Lorem Ipsum available','corpex'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'corpex_sanitize_html',
			'transport'         => $selective_refresh,
			'priority' => 6,
	...
	if ( class_exists( 'Cleverfox_Customizer_Range_Slider_Control' ) ) {
		...
		new Cleverfox_Customizer_Range_Slider_Control( $wp_customize, 'blog_display_num', 
			array(
				'label'      => __( 'No of Posts Display', 'corpex' ),
				'section'  => 'blog_setting',
				 'input_attrs' => array(
					'min'    => 1,
					'max'    => 500,
...
add_action( 'customize_register', 'corpex_blog_setting' );
