...
( function( $ ) {
	...
	CORPEXControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'corpex-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'corpex-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'corpex-control-trigger.' + hook, callback );
	    },
	};
	 ...
	 *
	 * @since 1.0.0
	 * @class CORPEXCustomizerToggles
	 */
	CORPEXCustomizerToggles = {
		...
		[
			{
				...
				callback: function( corpex_header_type ) {

					var corpex_header_type = api( 'corpex_header_type' ).get();

					if ( 'header-1' == corpex_header_type  || 'header-4' == corpex_header_type  || 'header-5' == corpex_header_type  || 'header-6' == corpex_header_type  || 'header-7' == corpex_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-1' == corpex_header_type  || 'header-4' == corpex_header_type || 'header-6' == corpex_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-4' == corpex_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-4' == corpex_header_type  || 'header-5' == corpex_header_type || 'header-6' == corpex_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-5' == corpex_header_type  || 'header-7' == corpex_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-5' == corpex_header_type || 'header-6' == corpex_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-6' == corpex_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( corpex_header_type ) {
					...
					if ( 'header-7' !== corpex_header_type) {
						return true;
					}
					return false;
				}
		...
		[
			{
				...
				callback: function( corpex_footer_type ) {

					var corpex_footer_type = api( 'corpex_footer_type' ).get();

					if ( 'footer-one' == corpex_footer_type || 'footer-two' == corpex_footer_type ) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( corpex_footer_type ) {
					...
					if ( 'footer-two' == corpex_footer_type ) {
						return true;
					}
					return false;
				}
