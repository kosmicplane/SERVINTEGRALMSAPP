 ...
 */
function corpex_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function corpex_sanitize_html( $html ) {
 ...
 */
function corpex_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function corpex_sanitize_range_value( $number, $setting ) {
 ...
 */
function corpex_sanitize_select( $input, $setting ) {
 ...
 */
function corpex_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function corpex_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function corpex_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}