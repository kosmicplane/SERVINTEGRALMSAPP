 ...
 *
 * @package     Corpex
 * @copyright   Copyright (c) 2022, Corpex
 * @since       1.0
 */
...
class Corpex_Icon_Picker_Control extends WP_Customize_Control{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Corpex_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', CORPEX_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'fonticonpicker-js', CORPEX_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
