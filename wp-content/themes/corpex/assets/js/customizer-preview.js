...
( function( $ ) {
	 ...
	 * Container Width
	 */
	wp.customize( 'corpex_site_cntnr_width', function( value ) {
		
		value.bind( function( corpex_site_cntnr_width ) {
			var class_name      = 'corpex_site_cntnr_width'; // Used as id in gfont link
			var css_class       = $( '.' + class_name );			
			
			if (corpex_site_cntnr_width >= 768 && corpex_site_cntnr_width <= 2000){
				var head_append     = '<style class="' + class_name + '">.container{ max-width: ' + corpex_site_cntnr_width + 'px;}</style>';
			}
	...
	wp.customize( 'footer_parallax_margin', function( value ) {
		value.bind( function( margin ) {
			jQuery( '.footer-parallax .corpex-content' ).css( 'margin-bottom', margin + 'px' );
		} );
	} );
	 ...
	 * Body font size
	 */
	wp.customize( 'corpex_body_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * Body font style
	 */
	wp.customize( 'corpex_body_font_style', function( value ) {
	 ...
	 * Body text tranform
	 */
	wp.customize( 'corpex_body_text_transform', function( value ) {
	...
	wp.customize( 'corpex_body_line_height', function( value ) {
	 ...
	 * H1 font family
	 */
	wp.customize( 'corpex_h1_font_family', function( value ) {
	 ...
	 * H1 font size
	 */
	wp.customize( 'corpex_h1_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H1 font style
	 */
	wp.customize( 'corpex_h1_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H1 text tranform
	 */
	wp.customize( 'corpex_h1_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H1 line height
	 */
	wp.customize( 'corpex_h1_line_height', function( value ) {
		value.bind( function( line_height ) {
	 ...
	 * H2 font family
	 */
	wp.customize( 'corpex_h2_font_family', function( value ) {
		value.bind( function( font_family ) {
	 ...
	 * H2 font size
	 */
	wp.customize( 'corpex_h2_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H2 font style
	 */
	wp.customize( 'corpex_h2_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H2 text tranform
	 */
	wp.customize( 'corpex_h2_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H2 line height
	 */
	wp.customize( 'corpex_h2_line_height', function( value ) {
		value.bind( function( line_height ) {
	 ...
	 * H3 font family
	 */
	wp.customize( 'corpex_h3_font_family', function( value ) {
		value.bind( function( font_family ) {
	 ...
	 * H3 font size
	 */
	wp.customize( 'corpex_h3_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H3 font style
	 */
	wp.customize( 'corpex_h3_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H3 text tranform
	 */
	wp.customize( 'corpex_h3_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H3 line height
	 */
	wp.customize( 'corpex_h3_line_height', function( value ) {
		value.bind( function( line_height ) {
	 ...
	 * H4 font family
	 */
	wp.customize( 'corpex_h4_font_family', function( value ) {
		value.bind( function( font_family ) {
	 ...
	 * H4 font size
	 */
	wp.customize( 'corpex_h4_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H4 font style
	 */
	wp.customize( 'corpex_h4_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H4 text tranform
	 */
	wp.customize( 'corpex_h4_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H4 line height
	 */
		wp.customize( 'corpex_h4_line_height', function( value ) {
		value.bind( function( line_height ) {
	 ...
	 * H5 font family
	 */
	wp.customize( 'corpex_h5_font_family', function( value ) {
		value.bind( function( font_family ) {
	 ...
	 * H5 font size
	 */
	wp.customize( 'corpex_h5_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H5 font style
	 */
	wp.customize( 'corpex_h5_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H5 text tranform
	 */
	wp.customize( 'corpex_h5_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H5 line height
	 */
		wp.customize( 'corpex_h5_line_height', function( value ) {
		value.bind( function( line_height ) {
	 ...
	 * H6 font family
	 */
	wp.customize( 'corpex_h6_font_family', function( value ) {
		value.bind( function( font_family ) {
	 ...
	 * H6 font size
	 */
	wp.customize( 'corpex_h6_font_size', function( value ) {
		value.bind( function( size ) {
	 ...
	 * H6 font style
	 */
	wp.customize( 'corpex_h6_font_style', function( value ) {
		value.bind( function( font_style ) {
	 ...
	 * H6 text tranform
	 */
	wp.customize( 'corpex_h6_text_transform', function( value ) {
		value.bind( function( text_tranform ) {
	 ...
	 * H6 line height
	 */
	wp.customize( 'corpex_h6_line_height', function( value ) {
		value.bind( function( line_height ) {
