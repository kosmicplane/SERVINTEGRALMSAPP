	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Suntech Pro','suntech' ),
                    'pro_url'  => 'https://desertthemes.com/themes/suntech-pro/',
                    'priority' => 0
                )
			)
		);
...
Suntech_Customize::get_instance();