(function ($) {
    ...
    wp.atuacustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                atua_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.atuacustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.atuacustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.atuacustomizerRepeater.iconPickerToggle($(this));
        });
