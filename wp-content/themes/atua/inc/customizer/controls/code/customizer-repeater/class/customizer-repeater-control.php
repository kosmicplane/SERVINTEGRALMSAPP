...
class ATUA_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->add_field_label = esc_html__( 'Add new field', 'atua' );
		if ( ! empty( $args['add_field_label'] ) ) {
			$this->add_field_label = $args['add_field_label'];
		}

		$this->boxtitle = esc_html__( 'Customizer Repeater', 'atua' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'atua_customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/inc/customizer/controls/code/customizer-repeater/css/admin-style.css', array(), 999 );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'atua_customizer-repeater-script', get_template_directory_uri() . '/inc/customizer/controls/code/customizer-repeater/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), 999, true  );

		wp_enqueue_script( 'atua_customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/inc/customizer/controls/code/customizer-repeater/js/fontawesome-iconpicker.js', array( 'jquery' ), 999, true );

		wp_enqueue_style( 'atua_customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/inc/customizer/controls/code/customizer-repeater/css/fontawesome-iconpicker.min.css', array(), 999 );
	}
	...
	private function iterate_array($array = array()){
		...
		if(!empty($array)){
			$exist_service=count($array);
				...
				$atua_del_btn_id=$this->boxtitle;
			
			global $atua_limit;
			global $atua_type_with_id;
			echo sprintf("<input type='hidden' value='$exist_service' id='exist_atua_$atua_del_btn_id'/>");
			foreach($array as $icon){ 
			if($it<4)
			{
			$atua_limit="atua_limit";
			$atua_type_with_id='';
			}
			else
			{
			$atua_limit="atua_overlimit";	
			$atua_type_with_id=$atua_del_btn_id."_".$it;
			}
					...
					<div class="customizer-repeater-box-content-hidden">
						...
						if($this->customizer_repeater_title_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Title','atua' ), $this->id, 'customizer_repeater_title_control' ),
								'class' => 'customizer-repeater-title-control '."$atua_limit".' '."$atua_type_with_id".'',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_title_control' ),
							), $title);
						}
						
						if($this->customizer_repeater_subtitle_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Subtitle','atua' ), $this->id, 'customizer_repeater_subtitle_control' ),
								'class' => 'customizer-repeater-subtitle-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_subtitle_control' ),
							), $subtitle);
						}
						
						if($this->customizer_repeater_subtitle2_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Subtitle 2','atua' ), $this->id, 'customizer_repeater_subtitle2_control' ),
								'class' => 'customizer-repeater-subtitle2-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_subtitle2_control' ),
							), $subtitle2);
						}
						
						if($this->customizer_repeater_subtitle3_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Subtitle 3','atua' ), $this->id, 'customizer_repeater_subtitle3_control' ),
								'class' => 'customizer-repeater-subtitle3-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_subtitle3_control' ),
							), $subtitle3);
						}
						
						if($this->customizer_repeater_subtitle4_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Subtitle 4','atua' ), $this->id, 'customizer_repeater_subtitle4_control' ),
								'class' => 'customizer-repeater-subtitle4-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_subtitle4_control' ),
							), $subtitle4);
						}
						
						if($this->customizer_repeater_subtitle5_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Subtitle 5','atua' ), $this->id, 'customizer_repeater_subtitle5_control' ),
								'class' => 'customizer-repeater-subtitle5-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_subtitle5_control' ),
							), $subtitle5);
						}
						
						if($this->customizer_repeater_text_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Description','atua' ), $this->id, 'customizer_repeater_text_control' ),
								'class' => 'customizer-repeater-text-control '."$atua_limit".' '."$atua_type_with_id".'',
								'type'  => apply_filters('atua_repeater_input_types_filter', 'textarea', $this->id, 'customizer_repeater_text_control' ),
							), $text);
						}
						if($this->customizer_repeater_text2_control==true){
                            $this->input_control(array(
                                'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Button Label','atua' ), $this->id, 'customizer_repeater_text2_control' ),
                                'class' => 'customizer-repeater-text2-control '."$atua_limit".'',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_text2_control' ),
                            ), $text2);
                        }
						
						if($this->customizer_repeater_button2_control==true){
                            $this->input_control(array(
                                'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Button Label second','atua' ), $this->id, 'customizer_repeater_button2_control' ),
                                'class' => 'customizer-repeater-button2-control',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_button2_control' ),
                            ), $button_second);
                        }
						...
						if($this->customizer_repeater_button_text_control){
							$this->input_control(array(
							'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__('Button Text',
							'atua'), $this->id, 'customizer_repeater_button_text_control'),
							'class' => 'customizer-repeater-button-text-control '."$atua_limit".'',
							'type' => apply_filters('atua_repeater_input_types_filter', '' , $this->id,
						...
						if($this->customizer_repeater_link_control){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Link','atua' ), $this->id, 'customizer_repeater_link_control' ),
								'class' => 'customizer-repeater-link-control '."$atua_limit".' '."$atua_type_with_id".'',
								'sanitize_callback' => 'esc_url_raw',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_link_control' ),
							), $link);
						}
						
						if($this->customizer_repeater_link2_control){
                            $this->input_control(array(
                                'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'link','atua' ), $this->id, 'customizer_repeater_link2_control' ),
                                'class' => 'customizer-repeater-link2-control '."$atua_limit".' '."$atua_type_with_id".'',
                                //'sanitize_callback' => 'esc_url_raw',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_link2_control' ),
                            ), $link2);
                        }
						...
						if($this->customizer_repeater_video_url_control){
							$this->input_control(array(
							'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__('Video Url',
							'atua'), $this->id, 'customizer_repeater_video_url_control'),
							'class' => 'customizer-repeater-video-url-control',
							'type'  => apply_filters('atua_customizer_repeater_video_url_control', 'textarea', $this->id, 'customizer_repeater_video_url_control' ),
							), $video_url);
						}
						...
						if($this->customizer_repeater_image_control == true && $this->customizer_repeater_icon_control == true) {
							$this->icon_type_choice( $choice,$atua_limit );
						}
						if($this->customizer_repeater_image_control == true){
							$this->image_control($image_url, $choice, $atua_limit, $it+1, $atua_del_btn_id);
						}
						if($this->customizer_repeater_image2_control == true){
							$this->image_control2($image_url2, $choice, $atua_limit, $it+1, $atua_del_btn_id);
						}
						...
						if($this->customizer_repeater_color_control == true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Color','atua' ), $this->id, 'customizer_repeater_color_control' ),
								'class' => 'customizer-repeater-color-control',
								'type'  => apply_filters('atua_repeater_input_types_filter', 'color', $this->id, 'customizer_repeater_color_control' ),
						...
						if($this->customizer_repeater_shortcode_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Shortcode','atua' ), $this->id, 'customizer_repeater_shortcode_control' ),
								'class' => 'customizer-repeater-shortcode-control',
                                'type'  => apply_filters('atua_repeater_input_types_filter', '', $this->id, 'customizer_repeater_shortcode_control' ),
							), $shortcode);
						}
						
						if($this->customizer_repeater_designation_control==true){
							$this->input_control(array(
								'label' => apply_filters('atua_repeater_input_labels_filter', esc_html__( 'Designation','atua' ), $this->id, 'customizer_repeater_designation_control' ),
								'class' => 'customizer-repeater-designation-control',
								'type'  => apply_filters('atua_repeater_input_types_filter', 'textarea', $this->id, 'customizer_repeater_designation_control' ),
							), $designation);
						}
						
						if($this->customizer_repeater_repeater_control==true){
							$this->repeater_control($repeater, $atua_limit, $atua_type_with_id);
						} ?>
						...
						<button type="button" class="social-repeater-general-control-remove-field" <?php if ( $it == 0 ) {
							...
							<?php printf( __( 'Delete %s', 'atua' ), $this->boxtitle );	?>
						</button>
			...
			<div class="customizer-repeater-general-control-repeater-container">
				...
				<div class="customizer-repeater-box-content-hidden">
					...
					<button type="button" class="social-repeater-general-control-remove-field button" style="display:none;">
						<?php esc_html_e( 'Delete field', 'atua' ); ?>
					</button>
				</div>
			</div>
			<?php
...
//print_r($options);
	...
	private function testimonila_check($value='no', $class='', $atua_type_with_id=''){
		?>
	<div class="customize-control-title">
	<?php esc_html_e('Open link in new tab:','atua'); ?>
	<span class="switch">
		<input type="checkbox" name="custom_checkbox" value="yes" <?php if($value=='yes'){echo esc_attr('checked');}?> class="customizer-repeater-checkbox <?php echo esc_attr($class);?> <?php echo esc_attr($atua_type_with_id);?>">
	</span>
	</div>
	<?php
	}
	...
	private function icon_picker_control($value = '', $show = '', $class=''){ ?>
		<div class="social-repeater-general-control-icon" <?php if( $show === 'customizer_repeater_image' || $show === 'customizer_repeater_none' ) { echo esc_attr('style="display:none;"'); } ?>>
            <span class="customize-control-title">
                <?php esc_html_e('Icon','atua'); ?>
            </span>
			<span class="description customize-control-description">
                <?php
                echo sprintf(
	                esc_html__( 'Note: Some icons may not be displayed here. You can see the full list of icons at %1$s.', 'atua' ),
	                sprintf( '<a href="http://fontawesome.io/icons/" rel="nofollow">%s</a>', esc_html__( 'http://fontawesome.io/icons/', 'atua' ) )
                ); ?>
            </span>
		...
		<div class="customizer-repeater-image-control" <?php if( $show === 'customizer_repeater_icon' || $show === 'customizer_repeater_none' ) { echo esc_attr('style="display:none;"'); } ?>>
            <span class="customize-control-title">
                <?php esc_html_e('Image','atua')?>
            </span>
			<input type="text" class="widefat custom-media-url <?php if($class="atua_overlimit") { echo esc_attr('atua-uploading-img');}?> <?php echo esc_attr($auto);?>" value="<?php echo esc_attr( $value ); ?>">
			<input type="button" class="button button-secondary customizer-repeater-custom-media-button <?php if($class="atua_overlimit") { echo esc_attr('atua-uploading-img-btn');}?> <?php echo esc_attr($auto);?>" value="<?php esc_attr_e( 'Upload Image','atua' ); ?>" />
		</div>
		<?php
	}
	...
	private function image_control2($value = '', $show = '', $class='', $auto='', $sections=''){ 
		...
		<div class="customizer-repeater-image2-control">
            <span class="customize-control-title">
                <?php esc_html_e('Image 2','atua')?>
            </span>
			<input type="text" class="widefat custom-media-url2 <?php if($class="atua_overlimit") { echo esc_attr('atua-uploading-img');}?> <?php echo esc_attr($auto);?>" value="<?php echo esc_attr( $value ); ?>">
			<input type="button" class="button button-secondary customizer-repeater-custom-media-button <?php if($class="atua_overlimit") { echo esc_attr('atua-uploading-img-btn');}?> <?php echo esc_attr($auto);?>" value="<?php esc_attr_e( 'Upload Image','atua' ); ?>" />
		</div>
		<?php
	}
	...
	private function icon_type_choice($value='customizer_repeater_icon', $atua_limit=''){ ?>
		<span class="customize-control-title">
            <?php esc_html_e('Image type','atua');?>
        </span>
		<select class="customizer-repeater-image-choice  <?php echo esc_attr($atua_limit);?>">
			<option value="customizer_repeater_icon" <?php selected($value,'customizer_repeater_icon');?>><?php esc_html_e('Icon','atua'); ?></option>
			<option value="customizer_repeater_image" <?php selected($value,'customizer_repeater_image');?>><?php esc_html_e('Image','atua'); ?></option>
			<option value="customizer_repeater_none" <?php selected($value,'customizer_repeater_none');?>><?php esc_html_e('None','atua'); ?></option>
		</select>
		<?php
	}

	private function repeater_control($value = '', $atua_limit='', $atua_type_with_id=''){
		$social_repeater = array();
		$show_del        = 0; ?>
		<span class="customize-control-title"><?php esc_html_e( 'Social icons', 'atua' ); ?></span>
		<?php
		if(!empty($value)) {
		...
		if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) { ?>
			<div class="customizer-repeater-social-repeater">
				<div class="customizer-repeater-social-repeater-container">
					...
					<?php get_template_part( $this->customizer_icon_container ); ?>
					<input type="text" class="customizer-repeater-social-repeater-link team_linkdata_<?php echo $atua_limit;?> <?php echo esc_attr($atua_type_with_id);?>"
					       placeholder="<?php esc_attr_e( 'Link', 'atua' ); ?>">
					<input type="hidden" class="customizer-repeater-social-repeater-id" value="">
					<button class="social-repeater-remove-social-item" style="display:none">
						<?php esc_html_e( 'Remove Icon', 'atua' ); ?>
					</button>
				</div>
				<input type="hidden" id="social-repeater-socials-repeater-colector" class="social-repeater-socials-repeater-colector" value=""/>
			</div>
			<button class="social-repeater-add-social-item button-secondary "><?php esc_html_e( 'Add Icon', 'atua' ); ?></button>
			<?php
		} else { ?>
			<div class="customizer-repeater-social-repeater">
				<?php
				foreach ( $social_repeater as $social_icon ) {
					...
					<div class="customizer-repeater-social-repeater-container">
						<div class="customizer-repeater-rc input-group icp-container">
							<input data-placement="bottomRight" class="icp icp-auto team_data_<?php echo esc_attr($atua_limit);?> <?php echo esc_attr($atua_type_with_id);?>" value="<?php if( !empty($social_icon['icon']) ) { echo esc_attr( $social_icon['icon'] ); } ?>" type="text">
						...
						<button class="social-repeater-remove-social-item"
						        ...
						        } ?>"><?php esc_html_e( 'Remove Icon', 'atua' ); ?></button>
					</div>
					<?php
				} ?>
			...
			<button class="social-repeater-add-social-item button-secondary <?php echo esc_attr($atua_limit);?> <?php echo esc_attr($atua_type_with_id);?>"><?php esc_html_e( 'Add Icon', 'atua' ); ?></button>
			<?php
		}
	}
}