            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#Atua_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('Atua_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="atua_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="atua_feature_thumbnail-button">Change Image</button> ' +
