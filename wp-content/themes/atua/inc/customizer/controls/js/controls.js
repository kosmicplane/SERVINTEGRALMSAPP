...
( function( api ) {
	...
	// Extends our custom "atua" section.
	api.sectionConstructor['atua'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-atua_sidebar_options select:not(#_customize-input-atua_default_pg_sidebar_option), #sub-accordion-section-atua_typography_options select, #sub-accordion-section-atua_headings_typography select").prop('disabled', true);
});