...
function accronfrontpagesectionsscroll( section_id ){
 ...
 jQuery('body').on('click', '#sub-accordion-panel-accron_frontpage_sections .control-subsection .accordion-section-title', function(event) {
        var section_id = jQuery(this).parent('.control-subsection').attr('id');
        accronfrontpagesectionsscroll( section_id );
});
