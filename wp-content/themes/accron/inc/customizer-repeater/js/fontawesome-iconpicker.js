(function ($) {
    ...
    wp.accroncustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                accron_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.accroncustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.accroncustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.accroncustomizerRepeater.iconPickerToggle($(this));
        });
