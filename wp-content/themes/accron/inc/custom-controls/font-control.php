 ...
 *
 * @package     Accron
 * @copyright   Copyright (c) 2022, Accron
 * @since       1.0
 */
...
class Accron_Icon_Picker_Control extends WP_Customize_Control{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Accron_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', ACCRON_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'fonticonpicker-js', ACCRON_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
