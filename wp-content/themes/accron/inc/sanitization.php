 ...
 */
function accron_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function accron_sanitize_html( $html ) {
 ...
 */
function accron_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function accron_sanitize_range_value( $number, $setting ) {
 ...
 */
function accron_sanitize_select( $input, $setting ) {
 ...
 */
function accron_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function accron_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function accron_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}