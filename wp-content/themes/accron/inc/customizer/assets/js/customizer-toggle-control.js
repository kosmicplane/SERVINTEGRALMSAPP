...
( function( $ ) {
	...
	ACCRONControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'accron-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'accron-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'accron-control-trigger.' + hook, callback );
	    },
	};
	 ...
	 *
	 * @since 1.0.0
	 * @class ACCRONCustomizerToggles
	 */
	ACCRONCustomizerToggles = {
		...
		[
			{
				...
				callback: function( accron_header_type ) {

					var accron_header_type = api( 'accron_header_type' ).get();

					if ( 'header-1' == accron_header_type  || 'header-4' == accron_header_type  || 'header-5' == accron_header_type  || 'header-6' == accron_header_type  || 'header-7' == accron_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-1' == accron_header_type  || 'header-4' == accron_header_type || 'header-6' == accron_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-4' == accron_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-4' == accron_header_type  || 'header-5' == accron_header_type || 'header-6' == accron_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-5' == accron_header_type  || 'header-7' == accron_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-5' == accron_header_type || 'header-6' == accron_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-6' == accron_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( accron_header_type ) {
					...
					if ( 'header-7' !== accron_header_type) {
						return true;
					}
					return false;
				}
		...
		[
			{
				...
				callback: function( accron_footer_type ) {

					var accron_footer_type = api( 'accron_footer_type' ).get();

					if ( 'footer-one' == accron_footer_type || 'footer-two' == accron_footer_type ) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( accron_footer_type ) {
					...
					if ( 'footer-two' == accron_footer_type ) {
						return true;
					}
					return false;
				}
