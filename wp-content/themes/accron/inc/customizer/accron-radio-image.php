...
/**
 * Accron
 * Customizer Control: Accron Radio Image control
 */
 if ( ! class_exists( 'Accron_Customize_Base_Control' ) ) {
	return;
}

class Accron_Customize_Control_Radio_Image extends Accron_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'accron-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="accron-radio-image-select">
