...
if ( ! class_exists( 'Remote_Startup_Solutions_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Remote_Startup_Solutions_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$remote_startup_solutions_contents = wp_remote_retrieve_body( $response );

			return $remote_startup_solutions_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Remote_Startup_Solutions_WPTT_WebFont_Loader( $url );
