...
?>
<section id="dt_service" class="dt_service dt_service--eight dt-py-default front-services" data-background="<?php echo esc_url(desert_companion_plugin_url);?>/inc/themes/corpiva/assets/images/services_bg.jpg">
			...
			?>
				<div class="dt-col-xl-3 dt-col-lg-4 dt-col-md-6 dt-col-sm-8">
					<div class="services-item">
						<span class="number">0<?php echo esc_html($i+1); ?></span>
