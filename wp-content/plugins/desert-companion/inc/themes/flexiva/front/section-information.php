...
?>
<section id="dt_service_one" class="dt_service dt_service--fifteen dt-py-default front-info">
					...
					?>
						<div class="dt_item_inner wow slideInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
							...
							<div class="dt_item_holder">
								...
								<?php if ( ! empty( $title ) ) : ?>
									<h5 class="dt_item_title"><a href="#"><?php echo esc_html($title); ?></a></h5>
								<?php endif; ?>	
								...
								<?php if ( ! empty( $link ) ) : ?>
									<div class="dt_item_readmore dt-mt-3"><a class="dt-btn-plustext" href="<?php echo esc_url($link); ?>"></a></div>
								<?php endif; ?>	
							</div>
						</div>
					<?php } } ?>
