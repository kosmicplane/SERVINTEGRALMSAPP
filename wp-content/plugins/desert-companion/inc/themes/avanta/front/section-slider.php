<?php  
	...
	$corpiva_slider_design					= get_theme_mod('corpiva_slider_design','dt_slider--six');
...
?>
<section id="dt_slider" class="dt_slider dt_slider--thumbnav dt_slider--kenburn dt_slider--six">
