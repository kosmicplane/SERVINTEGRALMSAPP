...
?>
<section id="dt_service" class="dt_service dt_service--ten dt-py-default front-services" data-background="<?php echo esc_url(desert_companion_plugin_url);?>/inc/themes/corpiva/assets/images/services_bg.jpg">
