...
?>
<section id="service4_options" class="dt__services dt__services--three dt-py-default front4--service">
				...
				<div class="dt-col-lg-4 dt-col-md-6 dt-col-12">
					<div class="dt__services-block">
						...
						<div class="dt__services-back">
							<?php if ( ! empty( $image )) : ?><div class="bg-img"><img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr($title); ?>"></div><?php endif; ?>
								<?php if ( ! empty( $title ) ) : ?>
								<h5 class="title"><a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?></a></h5>
							<?php endif; ?>
							<?php if ( ! empty( $text ) ) : ?>
