...
class BdevsProjects extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Our <span>Projects</span>', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);		
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Discover', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);	
	...
	public function render() {
		...
		$wp_query = new \WP_Query(array('posts_per_page' => $settings['post_number'],'post_type' => 'project',  'orderby' => $settings['orderby'], 'order' => $settings['orderpost']));
		extract($settings);
		?>  
            ...
            <div class="row">
	            ...
	            <?php if($idd%2=='1') {?>
	            	<div class="col-md-12 mb-90">
			            <div class="projects">
			                <figure><a href="<?php the_permalink();?>"><img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id());?>" alt="" class="img-fluid"></a></figure>
			                <div class="caption">
			                    <h4><a href="<?php the_permalink();?>"><?php the_title();?></a></h4>
			                    <p><?php if(isset($norcon_redux_demo['projects_excerpt'])){?>
			                            <?php echo esc_attr(norcon_excerpt3($norcon_redux_demo['projects_excerpt'])); ?>
			                            <?php }else{?>
			                            <?php echo esc_attr(norcon_excerpt3(10)); } ?></p>
			                    <div class="line-dec"></div>
			                    <div class="info-wrapper">
			                        <div class="date"><i class="norcon-new-construction"></i> <?php echo esc_attr($cate_name); ?></div>
			                        <div class="more"><a href="<?php the_permalink();?>" class="link-btn" tabindex="0"><?php echo wp_kses_post($settings['button']); ?></a></div>
			                    </div>
			                </div>
			            </div>
			        </div>
