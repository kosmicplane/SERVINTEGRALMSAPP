...
if (!class_exists('g5plusFrameWork')) {
	class g5plusFrameWork {
		...
		private function  define_constants() {
            ...
            if( ! defined( 'G5PLUS_FRAMEWORK_SHORTCODE_CATEGORY' ) ) {define( 'G5PLUS_FRAMEWORK_SHORTCODE_CATEGORY', esc_html__( 'Darna Shortcodes', 'g5plus-darna' ));}
		...
		private function includes() {
			...
			/*core*/
			require_once PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/g5plus-framework.php';
			...
			require_once PLUGIN_G5PLUS_FRAMEWORK_DIR . 'includes/theme-action.php';
			...
			/* widgets */
			require_once PLUGIN_G5PLUS_FRAMEWORK_DIR . 'includes/sidebar.php';
