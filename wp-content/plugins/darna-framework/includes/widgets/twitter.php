...
class G5Plus_Widget_Twitter extends  G5Plus_Widget {
    public function __construct() {
        ...
        $this->widget_description = __( "Display your latest tweets", 'g5plus-darna' );
        $this->widget_id          = 'g5plus-twitter';
        $this->widget_name        = __( 'G5Plus: Twitter', 'g5plus-darna' );
        $this->settings           = array(
            'title'  => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Title', 'g5plus-darna' )
            ),
            'user_name' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'User Name', 'g5plus-darna' )
            ),
            'consumer_key' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Consumer Key', 'g5plus-darna' )
            ),
            'consumer_secret' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Consumer Secret', 'g5plus-darna' )
            ),
            'access_token' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Access Token', 'g5plus-darna' )
            ),
            'access_token_secret' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Access Token Secret', 'g5plus-darna' )
            ),
            'time_to_store' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Time To Store', 'g5plus-darna' )
            ),
            'total_feed' => array(
                'type'  => 'text',
                'std'   => '',
                'label' => __( 'Total Feed', 'g5plus-darna' )
            )
        );
        parent::__construct();
    }
