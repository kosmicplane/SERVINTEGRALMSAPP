...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="rwmb-select-all-none">' . __( 'Select', 'g5plus-darna' ) . ': <a data-type="all" href="#">' . __( 'All', 'g5plus-darna' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'g5plus-darna' ) . '</a></div>';
		}
		return '';
	}
}
