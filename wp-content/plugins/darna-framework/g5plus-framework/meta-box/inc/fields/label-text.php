	...
	class RWMB_Label_Text_Field extends RWMB_Field {
		...
		static function html( $meta, $field )
		{
			...
			<ul class="label-text-wrapper">
				<li>
					<label for="<?php echo esc_attr($field['id'])  . '-label'; ?>"><?php esc_html_e('Label','g5plus-darna'); ?></label>
				...
				<li>
					<label for="<?php echo esc_attr($field['id'])  . '-text'; ?>"><?php esc_html_e('Text','g5plus-darna'); ?></label>
