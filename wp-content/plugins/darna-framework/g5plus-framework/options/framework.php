        ...
        class ReduxFramework {
            ...
            public function editor_stylesheets($stylesheets) {
                ...
                if ( ! empty ( $this->typography ) && ! empty ( $this->typography ) && filter_var( $this->args['output'], FILTER_VALIDATE_BOOLEAN ) ) {
                    ...
                    $stylesheets[] = $protocol . $typography->makeGoogleWebfontLink( $this->typography );
                }
                ...
                if ( empty ( $data ) && ! empty ( $type ) ) {
                    ...
                    if ( ! empty ( $type ) && empty ( $data ) ) {
                        ...
                        if ( $type == "categories" || $type == "category" ) {
                            ...
                            $terms = get_categories($args ); // this will get nothing
                            if ( ! empty ( $terms ) ) {
                    ...
                    if ( ! empty ( $values ) ) {
                        ...
                        try {
	                        ...
	                        if ($is_generate_less_to_css) {
		                        do_action('redux/generate_less_to_css',$success);
	                        }
	                        else {
